...
// ── Crop calendar data ─────────────────────────────────────
const CALENDAR_DATA = {
  January:   { crops: ['Wheat','Mustard','Peas','Masoor'],           img: '/static/images/peas.png' },
  February:  { crops: ['Wheat','Chana','Sunflower'],                 img: '/static/images/sunflowerr.png' },
  March:     { crops: ['Sugarcane','Vegetables','Maize'],             img: '/static/images/sugarcane.png' },
  April:     { crops: ['Cotton','Groundnut','Vegetables','Watermelon'], img: '/static/images/moong.png' },
  May:       { crops: ['Paddy Nursery','Jowar','Maize'],             img: '/static/images/jowar.png' },
  June:      { crops: ['Rice','Maize','Soybean','Cotton'],            img: '/static/images/rice.png' },
  July:      { crops: ['Rice','Sorghum','Bajra','Groundnut'],         img: '/static/images/groundnut.png' },
  August:    { crops: ['Rice','Maize','Pulses'],                      img: '/static/images/maize.png' },
  September: { crops: ['Rice','Vegetables','Maize'],                  img: '/static/images/rice.png' },
  October:   { crops: ['Wheat (sow)','Mustard','Potato'],             img: '/static/images/wheat.png' },
  November:  { crops: ['Wheat','Barley','Peas','Potato'],             img: '/static/images/potato.png' },
  December:  { crops: ['Wheat','Mustard','Vegetables','Masoor'],      img: '/static/images/mustard.png' }
};

// ── Marquee images ─────────────────────────────────────────
const MARQUEE_ITEMS = [
  { label: 'niger',     img: '/static/images/niger.png' },
  { label: 'linseed',   img: '/static/images/linseed.png' },
  { label: 'mango',     img: '/static/images/mango.png' },
  { label: 'masoor',    img: '/static/images/masoor.png' },
  { label: 'moong',     img: '/static/images/moong.png' },
  { label: 'moth bean', img: '/static/images/moth bean.png' },
  { label: 'mustard',   img: '/static/images/mustard.png' },
  { label: 'oats',      img: '/static/images/oats.png' },
  { label: 'onion',     img: '/static/images/onion.png' },
  { label: 'papaya',    img: '/static/images/papaya.png' },
  { label: 'peas',      img: '/static/images/peas.png' },
  { label: 'potato',    img: '/static/images/potato.png' },
  { label: 'pumpkin',   img: '/static/images/pumpkin.png' },
  { label: 'Rajma',     img: '/static/images/Rajma.png' },
  { label: 'rapeseed',  img: '/static/images/rapaseed.png' },
  { label: 'soyabean',  img: '/static/images/soyabean.png' },
  { label: 'sugarcane', img: '/static/images/sugarcane.png' },
  { label: 'sunflower', img: '/static/images/sunflowerr.png' },
  { label: 'tea',       img: '/static/images/tea.png' },
  { label: 'spinach',   img: '/static/images/spinach.png' },
  { label: 'sorghum',   img: '/static/images/sorghum.png' },
  { label: 'sesame',    img: '/static/images/sesame.png' },
  { label: 'safflower', img: '/static/images/safflower.png' },
  { label: 'rubber',    img: '/static/images/rubber.png' },
  { label: 'okra',      img: '/static/images/okra.png' },
  { label: 'rice',      img: '/static/images/rice.png' },
  { label: 'jute',      img: '/static/images/jute.png' },
  { label: 'horsegram', img: '/static/images/horsegram.png' },
  { label: 'jowar',     img: '/static/images/jowar.png' },
  { label: 'indigo',    img: '/static/images/indigo.png' },
  { label: 'maize',     img: '/static/images/maize.png' },
  { label: 'groundnut', img: '/static/images/groundnut.png' },
  { label: 'grapes',    img: '/static/images/grapes.png' },
];
